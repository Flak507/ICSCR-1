      ...
      <!-- <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-2">
            <div class="block">
              <h1 class="animated fadeInUp">International Commerce & Services Costa Rica</h1>
              <p class="animated fadeInUp">Soluciones Logísticas Innovadoras</p>
            </div>
          </div>
        </div>
      </div> -->
        ...
        <div class="row ">
              ...
              <div class="content">
                ...
                <a href="productos.html">
                  ...
                  <div class="content-details fadeIn-bottom">
                    ...
                    <p>
                      Logística Biomédica<br> KOALA BIOMED LINE
                      <!-- <a class="effect effect-2" href="#">Ver Más</a> -->
                    </p>
                  </div>
                  <div class="overlay-black"></div>
                </a>
          ...
          <div class="col-sm-6 col-md-4 special-hover">
            <div class="service-item">
              <div class="content">
                ...
                <a href="productos.html">
                  ...
                  <div class="content-details fadeIn-bottom">
                    ...
                    <p>
                      Logística alimentaria </br> CARGO LINE
                      <!-- <a class="effect effect-2" href="#">Ver Más</a> -->
                    </p>
                  </div>
                  <div class="overlay-black"></div>
              ...
              <!-- <h4>Cajas Isotérmicas</h4>
              <p class = "text-left">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>
              <p><a class="effect effect-2" href="#" title="Learn More">Ver Más</a></p> -->
            </div>
          </div>
          <div class="col-sm-6 col-md-4 special-hover">
            <div class="service-item">
              <div class="content">
                ...
                <a href="productos.html">
                  ...
                  <div class="content-details fadeIn-bottom">
                    ...
                    <p>
                      Temperatura y transporte </br> ACTIVE LINE
                      <!-- <a class="effect effect-2" href="#">Ver Más</a> -->
                    </p>
                  </div>
                  <div class="overlay-black"></div>
          ...
          <div class="col-sm-6 col-md-4 special-hover">
            <div class="service-item">
              <div class="content">
                <h1 class="title-products">Remolcadores 
                </br>
                Eléctricos</h1>
                <a href="productos.html">
                  <div class="content-overlay"></div>
          ...
          <div class="col-sm-6 col-md-4 special-hover">
            <div class="service-item">
              <div class="content">
                <h1 class="title-products">Contenedores</h1>
                <a href="productos.html">
                  <div class="content-overlay"></div>
           ...
           <div class="col-sm-6 col-md-4 special-hover">
            <div class="service-item">
              <div class="content">
                <h1 class="title-products">Partes y
                </br>
                Suministros</h1>
                <a href="productos.html">
                  <div class="content-overlay"></div>
          ...
          <div class="col-xs-12">
            <p class="mt-5">
              <a class="effect effect-2" href="productos.html">Ver Más productos</a>
            </p>
          </div>
        </div>
      </div>
